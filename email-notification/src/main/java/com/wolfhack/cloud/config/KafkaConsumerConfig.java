...
public class KafkaConsumerConfig {
	...
	@Bean
	public ConsumerFactory<String, UserRegisteredNotificationDTO> multicastMessageConsumerFactory() {
	...
	@Bean
	public ConsumerFactory<String, UserResetNotificationDTO> subscriptionConsumerFactory() {
		Map<String, Object> properties = getDefaultConsumerFactoryProperties();
		return new DefaultKafkaConsumerFactory<>(properties, new StringDeserializer(), new JsonDeserializer<>(UserResetNotificationDTO.class));
	}
