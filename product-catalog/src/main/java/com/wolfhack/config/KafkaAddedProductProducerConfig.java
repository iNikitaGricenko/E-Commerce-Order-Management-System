...
@Configuration
public class KafkaAddedProductProducerConfig {
	...
	@Bean
	public ProducerFactory<String, ProductAddedDTO> producerFactory() {
	...
	@Bean
	public KafkaTemplate<String, ProductAddedDTO> kafkaTemplate() {
